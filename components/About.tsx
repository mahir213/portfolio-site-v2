...
export default function About() {
  return (
    ...
    >
      ...
      {/* Subtle gradient overlays similar to Hero */}
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          >
            Born from curiosity. Sharpened by experience.
          </h2>
        </div>
        ...
        <div className="space-y-6 max-w-3xl">
          ...
          >
            As a full-stack developer focused on modern web technologies, I turn complex problems into clear, scalable systems. My stack includes React, Next.js, TypeScript, Node.js, Spring boot and PHP.
          </p>
